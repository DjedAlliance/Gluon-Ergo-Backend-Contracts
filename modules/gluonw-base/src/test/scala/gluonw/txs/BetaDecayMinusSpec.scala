    ...
    "chain through multiple betaDecayMinusTx" in {
      client.getClient.execute { implicit ctx =>
        ...
        (1 to 10).foreach { _ =>
          ...
          val paymentBox: InputBox =
            createPaymentBox(neutronsValue = neutronsToTransmute)
