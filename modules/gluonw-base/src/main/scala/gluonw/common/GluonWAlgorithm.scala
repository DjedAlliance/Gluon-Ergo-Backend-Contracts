...
case class GluonWAlgorithm(gluonWConstants: TGluonWConstants)
  ...
  def getVolumes(
    ...
    System.out.println("Volumes GAUC => GAU: " + volumes._1.map(_.toFloat/1e9) + " ; Total: " + volumes._1.sum.toFloat/1e9)
    System.out.println("Volumes GAU => GAUC: " + volumes._2.map(_.toFloat/1e9) + " ; Total: " + volumes._2.sum.toFloat/1e9)
    volumes
  }
